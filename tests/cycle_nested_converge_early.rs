...
fn the_test() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "salsa_event(WillIterateCycle { database_key: query_a(Id(0)), iteration_count: IterationStamp(1, 0) })",
            "salsa_event(WillExecute { database_key: query_b(Id(400)) })",
            "salsa_event(WillExecute { database_key: query_c(Id(800)) })",
            "salsa_event(DidFinalizeCycle { database_key: query_b(Id(400)), iteration_count: IterationStamp(1, 0) })",
            "salsa_event(WillExecute { database_key: query_d(Id(c00)) })",
            "salsa_event(WillIterateCycle { database_key: query_a(Id(0)), iteration_count: IterationStamp(2, 0) })",
            "salsa_event(WillExecute { database_key: query_d(Id(c00)) })",
            "salsa_event(WillIterateCycle { database_key: query_a(Id(0)), iteration_count: IterationStamp(3, 0) })",
            "salsa_event(WillExecute { database_key: query_d(Id(c00)) })",
            "salsa_event(DidFinalizeCycle { database_key: query_a(Id(0)), iteration_count: IterationStamp(3, 0) })",
        ]"#]]);
}
