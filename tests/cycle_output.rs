...
fn revalidate_with_change_after_output_read() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "salsa_event(WillIterateCycle { database_key: query_b(Id(0)), iteration: IterationStamp { iteration: 1, cancellation: 0 } })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(WillExecute { database_key: read_value(Id(401g1)) })",
            "salsa_event(WillIterateCycle { database_key: query_b(Id(0)), iteration: IterationStamp { iteration: 2, cancellation: 0 } })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(WillExecute { database_key: read_value(Id(402g1)) })",
            "salsa_event(WillIterateCycle { database_key: query_b(Id(0)), iteration: IterationStamp { iteration: 3, cancellation: 0 } })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(WillExecute { database_key: read_value(Id(403g1)) })",
            "salsa_event(DidFinalizeCycle { database_key: query_b(Id(0)), iteration: IterationStamp { iteration: 3, cancellation: 0 } })",
        ]"#]]);
}
