...
fn revalidate_with_change_after_output_read() {
    ...
    db.assert_logs(expect![[r#"
        [
            "salsa_event(DidSetCancellationFlag)",
            "salsa_event(DidValidateMemoizedValue { database_key: read_value(Id(100)) })",
            "salsa_event(WillExecute { database_key: query_d(Id(200)) })",
            "salsa_event(WillExecute { database_key: query_b(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(DidValidateInternedValue { key: query_d::interned_arguments(Id(200)), revision: R2 })",
            "salsa_event(WillDiscardStaleOutput { execute_key: query_a(Id(0)), output_key: Output(Id(101)) })",
            "salsa_event(DidDiscard { key: Output(Id(101)) })",
            "salsa_event(DidDiscard { key: read_value(Id(101)) })",
            "salsa_event(WillDiscardStaleOutput { execute_key: query_a(Id(0)), output_key: Output(Id(102)) })",
            "salsa_event(DidDiscard { key: Output(Id(102)) })",
            "salsa_event(DidDiscard { key: read_value(Id(102)) })",
            "salsa_event(WillDiscardStaleOutput { execute_key: query_a(Id(0)), output_key: Output(Id(103)) })",
