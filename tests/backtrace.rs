    ...
    expect![[r#"
        query stacktrace:
           ...
           1: query_cycle(Id(2))
                     ...
                     cycle heads: query_cycle(Id(2)) -> iteration = IterationStamp(0, 0)
           2: query_f(Id(2))
    ...
    expect![[r#"
        query stacktrace:
           0: query_e(Id(3)) -> (R1, Durability::LOW)
                     at tests/backtrace.rs:32
           1: query_cycle(Id(3)) -> (R1, Durability::HIGH, iteration = IterationStamp(0, 0))
                     at tests/backtrace.rs:45
                     cycle heads: query_cycle(Id(3)) -> iteration = IterationStamp(0, 0)
