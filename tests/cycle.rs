...
fn cycle_sibling_interference() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "salsa_event(WillIterateCycle { database_key: min_iterate(Id(0)), iteration_count: IterationStamp(1, 0) })",
            "salsa_event(WillExecute { database_key: min_iterate(Id(1)) })",
            "salsa_event(DidFinalizeCycle { database_key: min_iterate(Id(0)), iteration_count: IterationStamp(1, 0) })",
        ]"#]]);
}
...
fn repeat_query_participating_in_cycle() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "salsa_event(WillIterateCycle { database_key: head(Id(0)), iteration_count: IterationStamp(1, 0) })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_b(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_c(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_d(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_hot(Id(0)) })",
            "salsa_event(WillIterateCycle { database_key: head(Id(0)), iteration_count: IterationStamp(2, 0) })",
            "salsa_event(WillExecute { database_key: query_a(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_b(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_c(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_d(Id(0)) })",
            "salsa_event(WillExecute { database_key: query_hot(Id(0)) })",
            "salsa_event(DidFinalizeCycle { database_key: head(Id(0)), iteration_count: IterationStamp(2, 0) })",
        ]"#]]);
}
