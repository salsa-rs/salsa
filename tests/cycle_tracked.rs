...
fn main() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(102)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(103)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(100)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(101)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillIterateCycle { database_key: cost_to_start(Id(103)), iteration: 1 }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(101)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "DidFinalizeCycle { database_key: cost_to_start(Id(103)), iteration: 1 }",
            "DidSetCancellationFlag",
            "WillCheckCancellation",
            "WillExecute { database_key: create_graph(Id(0)) }",
            "WillDiscardStaleOutput { execute_key: create_graph(Id(0)), output_key: Node(Id(103)) }",
            "DidDiscard { key: Node(Id(103)) }",
            "DidDiscard { key: cost_to_start(Id(103)) }",
            "WillCheckCancellation",
            "WillCheckCancellation",
            "WillExecute { database_key: cost_to_start(Id(102)) }",
            "WillCheckCancellation",
...
fn test_cycle_with_fixpoint_structs() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "WillDiscardStaleOutput { execute_key: create_tracked_in_cycle(Id(0)), output_key: IterationNode(Id(102)) }",
            "DidDiscard { key: IterationNode(Id(102)) }",
        ]"#]]);
}
