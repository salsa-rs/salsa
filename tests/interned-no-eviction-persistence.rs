...
#[salsa::interned(persist, eviction(policy = no_eviction))]
struct Name<'db> {
    text: String,
}

#[test]
fn no_eviction_persistence_restores_generation_and_metadata() {
    ...
    // Accept metadata produced by an LRU-enabled version of the ingredient.
