...
fn the_test() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "WillCheckCancellation",
            "WillIterateCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 1, cancellation: 0 } }",
            "WillCheckCancellation",
            "WillIterateCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 2, cancellation: 0 } }",
            "WillCheckCancellation",
            "WillIterateCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 3, cancellation: 0 } }",
            "WillCheckCancellation",
            "WillIterateCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 4, cancellation: 0 } }",
            "WillCheckCancellation",
            "WillIterateCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 5, cancellation: 0 } }",
            "WillCheckCancellation",
            "DidFinalizeCycle { database_key: query(Id(0)), iteration: IterationStamp { iteration: 5, cancellation: 0 } }",
