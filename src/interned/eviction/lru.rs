...
use crate::interned::{Configuration, DEFAULT_REVISIONS, HashEqLike, Value};
...
impl EvictionPolicy for Lru {
        ...
        Assemble: FnOnce(Id, Key) -> C::Fields<'db>,
    {
        ...
        let hasher = |id: &Id| unsafe { ingredient.value_hash(*id, zalsa) };
        ...
        key_map.insert_unique(hash, slot.new_id, hasher);
