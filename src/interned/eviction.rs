...
use super::{Configuration, HashEqLike, IngredientImpl, Value};
...
pub struct InternMissing<'a, 'db, C: Configuration, Key, Assemble> {
    ...
    pub(super) key_map: &'a mut hashbrown::HashTable<Id>,
    ...
    Assemble: FnOnce(Id, Key) -> C::Fields<'db>,
{
    ...
    pub(super) fn intern_new(self) -> Id {
        ...
        unsafe { ingredient.insert_value(id, zalsa, key_map, shard, hash, value) };
