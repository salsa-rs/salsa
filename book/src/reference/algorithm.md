...
let module = Module::new(&db, "fn foo() { }".to_string());
...
module
    .set_text(&mut db)
    .to("fn foo() { /* add a comment */ }".to_string());
...
When you set the value of an input field, you can also set it with a given _durability_:
