//! Compares eviction policies across large, multi-revision workloads.
//!
//! These workloads deliberately perform enough query computation and
//! allocation to make eviction decisions observable. They use wall-time and
//! memory instrumentation because CPU simulation makes their long instruction
//! traces prohibitively expensive.
//!
